...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: 'Carpeta oficio con acco clip plástico resistente, disponible en colores variados (azul, blanco, café, celeste, rojo, rosado, verde claro, gris).',
    price: 890,
    category: 'utiles',
    inBanner: false,
    inStock: true,
  ...
  {
    id: 165,
    title: 'Marcador Permanente Redondo Rojo',
    description: 'Marcador permanente redondo color rojo, 12 unidades marca Fultons para señalización.',
    price: 390,
    category: 'utiles',
    inBanner: false,
    inStock: true,
    subCategory: 'plumones-destacadores',
    images: [getImagePath('MARCADOR PERMANENTE REDONDO ROJO 12 UNIDADES FULTONS.jpg')],
  },
  {
    id: 166,
